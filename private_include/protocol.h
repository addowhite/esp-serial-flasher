...
esp_loader_error_t loader_flash_begin_cmd(void *ctx, uint32_t offset, uint32_t erase_size, uint32_t block_size, uint32_t blocks_to_write, bool encryption);
...
esp_loader_error_t loader_flash_read_rom_cmd(void *ctx, uint32_t address, uint8_t *data);

esp_loader_error_t loader_flash_read_stub_cmd(void *ctx, uint32_t address, uint32_t size, uint32_t size_per_packet);
...
esp_loader_error_t loader_write_reg_cmd(void *ctx, uint32_t address, uint32_t value, uint32_t mask, uint32_t delay_us);
